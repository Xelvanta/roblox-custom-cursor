...
pythonw "C:\\Program Files\\Xelvanta Softworks\\rcur_importer.pyw" "%~1"
\'\'\'

try:
    launcher_path = os.path.join(
       os.environ["SystemDrive"] + "\\\\",
        "Program Files", "Xelvanta Softworks", "rcur_importer_launcher.bat"
    )

    rcur_importer_path = os.path.join(
       os.environ["SystemDrive"] + "\\\\",
        "Program Files", "Xelvanta Softworks", "rcur_importer.pyw"
    )
